...
!function() {
    ...
    function c(e, t, n) {
        var r, o, a, s, c, i = n.indexOf(e), u = n.indexOf(t, i + 1), l = i;
        if (i >= 0 && u > 0) {
            if (e === t)
                return [i, u];
            for (r = [],
                     a = n.length; l >= 0 && !c; )
                l == i ? (r.push(l),
                    i = n.indexOf(e, l + 1)) : 1 == r.length ? c = [r.pop(), u] : ((o = r.pop()) < a && (a = o,
                    s = u),
                    u = n.indexOf(t, l + 1)),
                    l = i < u && i >= 0 ? i : u;
            r.length && (c = [a, s])
    ...
    function i(t) {
        ...
        function M(e) {
            if (!e && !u())
                return c("missing '{'");
            for (var n, r = m(); t.length && (e || "}" !== t[0]) && (n = O() || _()); )
                n.type && r.push(n),
                    r = r.concat(m());
    ...
    function p(e) {
        ...
        function a(e) {
            var r = e.split(",")[0].replace(/[\s\n\t]/g, "")
                ...
                , c = n || e;
            return a || t.onWarning('variable "'.concat(r, '" is undefined')),
                s && "undefined" !== s && s.length > 0 ? p(s, t, c) : "var(".concat(c, ")")
        }
        if (r) {
            if ("var" === r.pre.slice(-3)) {
                var s = 0 === r.body.trim().length;
                return s ? (t.onWarning("var() must contain a non-whitespace string"),
                    e) : r.pre.slice(0, -3) + a(r.body) + p(r.post, t)
            }
    ...
    function L() {
        ...
        if (v) {
            ...
            if (!1 === o.watch && S && (S.disconnect(),
                ...
                if (o.__benchmark = N(),
                    o.exclude = [S ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', "link[disabled]:not([data-cssvars])", o.exclude].filter((function(e) {
                            return e
                        }
                    )).join(","),
                    ...
                    d.forEach((function(e) {
                            ...
                            t && n && (e.sheet && (e.sheet.disabled = !1),
                        ...
                        n({
                            ...
                            onSuccess: function(e, t, n) {
                                ...
                                var r = "link" === t.nodeName.toLowerCase()
                                    ...
                                    , s = o.onSuccess(e, t, n);
                                return e = void 0 !== s && !1 === Boolean(s) ? "" : s || e,
                            ...
                            onComplete: function(t, n) {
                                ...
                                if (w.job = {},
                                    ...
                                    e(w.job, w.dom),
                                    o.updateDOM ? (e(w.user, o.variables),
                                        e(w.job, w.user)) : (e(w.job, w.user, o.variables),
                                        e(d, o.variables)),
                                y.job > 0 && Boolean(Object.keys(w.job).length > Object.keys(d).length || Boolean(Object.keys(d).length && Object.keys(w.job).some((function(e) {
                                        return w.job[e] !== d[e]
                                    }
                                )))))
                                    V(o.rootElement),
                                                ...
                                                if (t.__cssVars.tree)
                                                    try {
                                                        ...
                                                        if (o.updateDOM) {
                                                            ...
                                                            t.textContent.replace(/\s/g, "") !== i && m.push(i)
                                                    } catch (e) {
                                                        a(e.message, t)
                                                    }
    ...
    function k(e) {
        ...
        window.MutationObserver && (S && (S.disconnect(),
            S = null),
                    ...
                    o.some((function(o) {
                            return function(r) {
                                ...
                                if ("attributes" === r.type && n(r.target) && !t(r.target)) {
                                    ...
                                    a ? o = !c && !i : s && (c ? r.target.setAttribute("data-cssvars", "") : i && V(e.rootElement, !0),
                                        o = !0)
                                }
                                return o
                            }(o) || function(e) {
    ...
    function j() {
        ...
        return Object.keys(e).reduce((function(n, r) {
                return n[t.test(r) ? r : "--".concat(r.replace(/^-+/, ""))] = e[r],
                    n
            }
        ), {})
    }
    ...
    function q(e, t) {
        ...
        if (r && o) {
            ...
            if (!a) {
                ...
                for (null !== n && s.setAttribute("tabindex", n),
                         e.insertBefore(s, o); e.childNodes[0] !== s; )
    ...
    if (window) {
        ...
        L(B),
            ...
            window.$docsify.plugins = [].concat([function(e, t) {
                e.init((function() {
                        !1 !== ((window.$docsify || {}).themeable || {}).readyTransition && (document.body.classList.add("ready-transition"),
                            setTimeout((function() {
                    ...
                    e.mounted((function() {
                            var e = document.querySelector(".content")
                                , t = setInterval((function() {
                                    e.textContent.length && (document.body.classList.add("ready-fix"),
                                        clearInterval(t))
                                }
                            ), 250)
                        }
                ...
                , D("4.8.0", (function(e, t) {
                        e.ready((function() {
                                ...
                                e && e.addEventListener("click", (function(r) {
                                        (r.target === n || n.contains(r.target)) && (e.classList.remove("show"),
                                            t.focus())
                                    }
                                )),
